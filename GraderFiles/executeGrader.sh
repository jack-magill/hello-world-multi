...
HELLO_WORLD_PART_ID="xGIj5"
HELLO_WORLD_2_PART_ID="JZcEe"
...
if [ "$PARTID" == "$HELLO_WORLD_PART_ID" ]; then
  GRADER_DIRECTORY=HelloWorldGrader
  SUBMISSION_CLASS=helloWorld
elif [ "$PARTID" == "$HELLO_WORLD_2_PART_ID" ]; then
  GRADER_DIRECTORY=HelloWorld2Grader
  SUBMISSION_CLASS=helloWorld2
else
